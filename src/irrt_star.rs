...
impl IRRTStarParams {
    ...
    pub fn from_file(filename: &str) -> Self {
        let cfg = Config::builder()
            ...
            .build()
            .unwrap()
            .try_deserialize::<IRRTStarParams>()
            .unwrap();
        cfg
    }
...
impl IRRTStar {
    ...
    pub fn grow_towards_goal(
        ...
        if verbose {
            println!(
                "[Informed-RRT*] Runtime: {:?} | Best solution cost: {:.2} | Number of nodes: {} | Tree size: {}",
