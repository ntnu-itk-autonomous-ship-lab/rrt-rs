...
class InformedRRTStar(ci.ICOLAV):
    def __init__(self, params: InformedRRTStarParams) -> None:
        self._rrt_params = params
        self._rrt = rrt_star_lib.InformedRRTStar(params)
...
if __name__ == "__main__":
    rrt = InformedRRTStar(InformedRRTStarParams())
